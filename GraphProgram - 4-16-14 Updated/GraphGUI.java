...
public class GraphGUI {
	...
	// PARALLEL PORTION:,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
	AStarThread startToGoal;
	AStarThread goalToStart;
...
//				System.out.println(exTime);
	...
	public void calcBidirectionalAStar() {

		startToGoal = new AStarThread("1", this, startNode, goalNode);//, dijkstrasHeuristic);
		goalToStart = new AStarThread("2", this, goalNode, startNode);//, dijkstrasHeuristic);

		startNode.isStart = true;
		goalNode.isGoal = true;

		System.out.println("The error occurs in each individual thread...");
		startToGoal.run();
		goalToStart.run();
